...
export default function Salad() {
  ...
  const handleAddToCart = (index) => {
    ...
    const totalPrice = salad.price * newQuantity;
    addToCart({
      image: salad.src,
      name: salad.label,
      price: salad.price,
    ...
    <div className="w-[55rem] mt-5">
      ...
      <div className="grid grid-cols-3 gap-y-5 mt-7 gap-x-9 mb-5">
        {salads.map((salad, index) => (
          ...
          >
            <img src={salad.src} alt={salad.label} className="w-[100%]  mt-1" />
            <p className="text-green text-medium pl-3 mt-2">฿{salad.price}</p>
